...
public class CVurlWithPredefinedResponseTest {
    ...
    public void asyncAsObjectWithClassTest() throws ExecutionException, InterruptedException {
        ...
        //when
        CompletableFuture<User> future = cVurl.get(Urls.TEST_URL).asyncAsObject(User.class);
    ...
    public void asyncAsObjectWithClassAndStatusCodeTest() throws ExecutionException, InterruptedException {
        ...
        //when
        CompletableFuture<User> future = cVurl.get(Urls.TEST_URL).asyncAsObject(User.class, 200);
    ...
    public void asyncAsObjectWithTypeTest() throws ExecutionException, InterruptedException {
        ...
        //when
        CompletableFuture<User> future = cVurl.get(Urls.TEST_URL).asyncAsObject(bodyType);
    ...
    public void asyncAsObjectWithTypeAndStatusCodeTest() throws ExecutionException, InterruptedException {
        ...
        //when
        CompletableFuture<User> future = cVurl.get(Urls.TEST_URL).asyncAsObject(bodyType, 200);
    ...
    public void asyncAsStringTest() throws ExecutionException, InterruptedException {
        ...
        //when
        CompletableFuture<Response<String>> future = cVurl.get(Urls.TEST_URL).asyncAsString();
    ...
    public void asyncAsStringWithPPHTest() throws ExecutionException, InterruptedException {
        ...
        //when
        CompletableFuture<Response<String>> future = cVurl.get(Urls.TEST_URL)
    ...
    public void asyncAsStreamTest() throws ExecutionException, InterruptedException {
        ...
        //when
        CompletableFuture<Response<InputStream>> future = cVurl.get(Urls.TEST_URL).asyncAsStream();
    ...
    public void asyncAsStreamWithPPHTest() throws ExecutionException, InterruptedException {
        ...
        //when
        CompletableFuture<Response<InputStream>> future = cVurl.get(Urls.TEST_URL)
    ...
    public void asObjectWithClassTest() {
        ...
        //when
        User result = cVurl.get(Urls.TEST_URL).asObject(User.class);
    ...
    public void asObjectWithClassAndStatusCodeTest() {
        ...
        //when
        User result = cVurl.get(Urls.TEST_URL).asObject(User.class, 200)
    ...
    public void asObjectWithTypeTest() {
        ...
        //when
        User result = cVurl.get(Urls.TEST_URL).asObject(bodyType);
    ...
    public void asObjectWithTypeAndStatusCodeTest() {
        ...
        //when
        User result = cVurl.get(Urls.TEST_URL).asObject(bodyType, 200)
                .orElseThrow(IllegalStateException::new);
    ...
    public void asStringTest() {
        ...
        //when
        String result = cVurl.get(Urls.TEST_URL).asString().orElseThrow(IllegalStateException::new).getBody();
    ...
    public void asStreamTest() {
        ...
        //when
        InputStream result = cVurl.get(Urls.TEST_URL).asStream().orElseThrow(IllegalStateException::new).getBody();
    ...
    public void asTest() {
        ...
        //when
        String result = cVurl.get(Urls.TEST_URL).as(HttpResponse.BodyHandlers.ofString()).orElseThrow(IllegalStateException::new).getBody();
